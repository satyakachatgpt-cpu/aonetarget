    ...
    <React.Fragment>
      <div
        onClick={() => {
          ...
          if (isFolder) handlers.onToggleFolder(item);
                ...
                return (
                  <div className="flex flex-wrap gap-1.5">
                    {chips.map((chip, idx) => (
                      ...
                      >
                        {chip.count} {chip.label}{chip.count > 1 ? (chip.label === 'PDF' ? 's' : 's') : ''}
                      </span>
                    ))}
                  </div>
                );
          ...
          {openContentActionMenuId === itemId && (
            ...
            >
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handlers.onToggleStatus(item, isFolder, isVideo, isNote, isTest, isLiveStream);
                }}
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handlers.onToggleFree(item, isFolder, isVideo, isNote, isTest);
                }}
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handlers.onEdit(item, isFolder, isVideo, isNote, isTest, isLiveStream);
                }}
                className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 transition-colors group"
              >
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handlers.onDelete(itemId || '', item.type, isFolder, isVideo, isNote, isTest, isLiveStream);
                }}
