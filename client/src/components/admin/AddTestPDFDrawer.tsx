                        ...
                        {activeTab === 'Basic' ? (
                            <div className="space-y-8">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-10 items-center">
                                        {/* Preview Box */}
                                        <div className="w-[180px] h-[180px] bg-[#ededed] border border-gray-100 rounded-2xl flex flex-col items-center justify-center gap-3 group relative overflow-hidden flex-shrink-0 animate-in fade-in zoom-in-95 duration-200">
                                            {formData.pdfFile ? (
                                                <div className="flex flex-col items-center gap-2 p-2 w-full h-full text-center">
                                                    ...
                                                    <p className="text-[11px] font-extrabold text-gray-600 px-2 line-clamp-2 uppercase tracking-tighter">{formData.pdfFile.name}</p>
                                                    <button
                                                        onClick={(e) => { e.stopPropagation(); setFormData(prev => ({ ...prev, pdfFile: null })); }}
                                                ...
                                                <>
                                                    <span className="material-symbols-outlined text-[48px] text-gray-500/50">picture_as_pdf</span>
                                                    <p className="text-[14px] font-black text-gray-400 uppercase tracking-widest mt-1">No PDF</p>
                                                </>
                                            )}
                                        </div>
                                        ...
                                        <div
                                            ...
                                            className="flex-1 h-[180px] border-2 border-dashed border-[#e2e8f0] rounded-[2.5rem] flex flex-col items-center justify-center transition-all bg-white hover:bg-gray-50/50 cursor-pointer group">
                                            <input
                                                type="file"
                                                ref={pdfInputRef}
                                                accept=".pdf"
                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-right-2 duration-300">
                                <div className="grid grid-cols-2 gap-x-12 gap-y-8">
                                    ...
                                    {/* Sorting Order */}
                                    <div className="space-y-2">
                                        <label className="text-[14px] font-bold text-[#1e1e1e]">Sorting Order<span className="text-[#e11d48] ml-0.5">*</span></label>
                                        <input
                                            type="text"
                                            value={formData.sortingOrder}
                                            onChange={(e) => handleInputChange('sortingOrder', e.target.value)}
                                            className="w-full h-11 px-4 bg-white border border-gray-200 rounded-xl text-[14px] font-medium outline-none focus:border-gray-400 transition-all"
                                        />
                                    </div>
