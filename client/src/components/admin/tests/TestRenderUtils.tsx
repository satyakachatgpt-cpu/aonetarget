...
/**
 * Helper to render diagrams/images for questions and options
 */
export const renderDiagram = (
  q: any, 
  field: string = "question", 
  isEditable: boolean = false,
  handleImageSelect?: (data: string, context: { questionId: any; field: string }) => void,
  handleRemoveImage?: (questionId: any, field: string) => void
) => {
  let dataUrl = "";
  if (field === "question") {
  ...
  if (!dataUrl) {
    if (!isEditable || !handleImageSelect) return null;
    return (
