                      ...
                      <td className="px-4 py-8 align-top text-center border-b border-gray-50/50 action-menu-container">
                        <div className="relative inline-block">
                          <button
                            ...
                            className={`flex items-center justify-center gap-1.5 px-3 py-1.5 border rounded-lg text-[13px] font-bold transition-all shadow-sm group ${
                          ...
                          {activeActionMenuId === rq.id && (
                            <div
                              className={`absolute right-0 w-[140px] bg-white rounded-xl shadow-2xl border border-gray-100 z-[100] py-2 overflow-hidden animate-in fade-in zoom-in-95 duration-200 ${
                                filteredReported.length > 3
                      ...
                      <td className="px-6 py-8 align-top text-right pr-6 border-b border-gray-50/50 action-menu-container">
                        <div className="relative inline-block">
                          <button
                            ...
                            className={`flex items-center justify-between gap-2 px-4 py-2 border rounded-lg text-[13px] font-bold transition-all shadow-sm w-[110px] ${
                              activeActionMenuId ===
                              (q.id || (q as any)._id) + 20000
                                ? "bg-blue-50 border-blue-200 text-blue-700"
                                : "bg-white border-gray-200 text-gray-700 hover:bg-gray-50"
            ...
            <div className="flex flex-wrap gap-5 pt-1">
              {formats.map((fmt) => (
                <div
                  ...
                  className={`relative cursor-pointer rounded-lg border-2 transition-all duration-200 overflow-hidden select-none flex-shrink-0 ${
                    bulkUploadData.format === fmt.key
                      ? "border-black"
